...
resulting trades two ways: resample (CI around total return) and shuffle
(isolates how much of drawdown is trade order/luck vs. the trades themselves).

Run: python run_bootstrap_demo.py
"""
