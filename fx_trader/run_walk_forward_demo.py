...
slides a window through history, re-selects fast/slow periods from a grid
on each in-sample slice, reports ONLY out-of-sample performance per window
and combined.

Run: python run_walk_forward_demo.py
"""
...
def main():
    ...
    result = run_walk_forward(
        candles, strategy_factory=SmaCrossoverStrategy, param_grid=param_grid,
        in_sample_size=500, out_of_sample_size=150,
