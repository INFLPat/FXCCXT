...
Minimal stand-in for a ccxt exchange object, implementing just the methods
CcxtBroker calls. Lets CcxtBroker's own logic be tested with no network
access and without ccxt installed, by injecting this instead of a real
exchange.
"""
