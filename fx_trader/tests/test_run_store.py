...
Verifies RunStore persists a real BacktestResult correctly and that
list_runs()/get_trades() round-trip what record_run() wrote.

Run: python -m tests.test_run_store
"""
