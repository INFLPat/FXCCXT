...
Verifies FxStore.get_candles_multi() - the multi-instrument query helper for
the future cross-pair/cartesian comparison work.

Run: python -m tests.test_multi_query
"""
