...
synthetic FX data, reporting how performance varies across the grid, with a
neighbor-gap diagnostic per top result (plateau vs. isolated spike).

Run: python run_sensitivity_demo.py
"""
